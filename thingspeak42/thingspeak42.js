          ...
          return new Promise((resolve, reject) => {
            ...
            const req = https.request(options, (res) => {
              if (res.statusCode !== 200) {
                ...
                node.status({fill:"red",shape:"dot",text:"error occured, status: " + res.statusCode});
              ...
              creationPending = false;
              node.error(e, "occured while creating channel")
            })
        ...
        function publishData() {
          ...
          https.get(url, function(response) {
            if(response.statusCode == 200){
              ...
              node.status({fill:"red",shape:"dot",text:"uploading failed, status code " + response.statusCode});
